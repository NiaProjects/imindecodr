    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto text-center">
          {/* Floating badges */}
          <div
            className=" hidden md:block absolute top-10 left-10 opacity-0 animate-fade-in"
          ...
          <div
            className="hidden md:block absolute top-20 right-10 opacity-0 animate-fade-in"
