...
const translations = {
  en: {
    ...
    "hero.subtitle":
      "Discover the art of sophisticated interior design with IMIC Decor - where elegance meets functionality in every detail.",
    ...
    "services.subtitle":
      "Crafting exceptional spaces that reflect your unique style and elevate your lifestyle",
    "services.kitchen.title": "Kitchen Design",
    "services.kitchen.desc":
      "Modern culinary spaces that blend functionality with elegance",
    "services.bedroom.title": "Bedroom Design",
    "services.bedroom.desc":
      "Luxurious retreats designed for comfort and tranquility",
    "services.office.title": "Office Design",
    "services.office.desc":
      "Professional environments that inspire productivity and success",
    ...
    "whyChoose.experience.desc":
      "Our certified designers bring years of experience and creativity to every project",
    "whyChoose.quality.title": "Premium Quality",
    "whyChoose.quality.desc":
      "We use only the finest materials and work with trusted suppliers worldwide",
    "whyChoose.service.title": "Personalized Service",
    "whyChoose.service.desc":
      "Every project is tailored to your unique style, needs, and budget",
    "whyChoose.delivery.title": "Timely Delivery",
    "whyChoose.delivery.desc":
      "We pride ourselves on completing projects on time without compromising quality",

    // Our Clients
    "clients.title": "Our Valued Clients",
    "clients.subtitle":
      "Trusted by leading companies and discerning homeowners",
    ...
    // Buttons
    "button.getConsultation": "Get Consultation",
    "button.backToHome": "Back to Home",
    "button.tryAgain": "Try Again",
    "button.viewProject": "View Project",
    "button.learnMore": "Learn More",
    "button.loading": "Loading...",
    "button.loadingProjects": "Loading projects...",
    "button.errorLoading": "Error loading projects",
    "button.noProjectsFound": "No projects found in this category.",

    // Footer
    "footer.company": "IMIC Decor",
    "footer.description":
      "Creating exceptional interior spaces that reflect your unique style and elevate your lifestyle.",
  ...
  ar: {
    ...
    "hero.subtitle":
      "اكتشف فن التصميم الداخلي المتطور مع إيميك ديكور - حيث تلتقي الأناقة بالوظائف في كل تفصيلة.",
    ...
    "services.subtitle":
      "صياغة مساحات استثنائية تعكس أسلوبك الفريد وترفع من مستوى معيشتك",
    ...
    "whyChoose.experience.desc":
      "مصممونا المعتمدون يجلبون سنوات من الخبرة والإبداع لكل مشروع",
    "whyChoose.quality.title": "جودة مميزة",
    "whyChoose.quality.desc":
      "نستخدم أجود المواد ونعمل مع موردين موثوقين حول العالم",
    "whyChoose.service.title": "خدمة شخصية",
    "whyChoose.service.desc":
      "كل مشروع مُصمم خصيصاً لأسلوبك واحتياجاتك وميزانيتك الفريدة",
    "whyChoose.delivery.title": "التسليم في الوقت المحدد",
    "whyChoose.delivery.desc":
      "نفتخر بإنجاز المشاريع في الوقت المحدد دون المساومة على الجودة",

    // Our Clients
    "clients.title": "عملاؤنا الكرام",
    "clients.subtitle":
      "موثوقون من قبل الشركات الرائدة وأصحاب المنازل المميزين",
    ...
    "about.description":
      "بسنوات من الخبرة في إنشاء مساحات داخلية استثنائية، أثبتت إيميك ديكور نفسها كاسم رائد في التصميم الداخلي الفاخر. نؤمن أن كل مساحة تحكي قصة، ومهمتنا هي مساعدتك في حكاية قصتك من خلال التصميم المدروس والمواد الفاخرة والاهتمام الدقيق بالتفاصيل.",
    ...
    // Buttons
    "button.getConsultation": "احصل على استشارة",
    "button.backToHome": "العودة للرئيسية",
    "button.tryAgain": "حاول مرة أخرى",
    "button.viewProject": "عرض المشروع",
    "button.learnMore": "اعرف المزيد",
    "button.loading": "جاري التحميل...",
    "button.loadingProjects": "جاري تحميل المشاريع...",
    "button.errorLoading": "خطأ في تحميل المشاريع",
    "button.noProjectsFound": "لم يتم العثور على مشاريع في هذه الفئة.",

    // Footer
    "footer.company": "إيميك ديكور",
    "footer.description":
      "إنشاء مساحات داخلية استثنائية تعكس أسلوبك الفريد وترفع من مستوى معيشتك.",
